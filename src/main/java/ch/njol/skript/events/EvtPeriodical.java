...
public class EvtPeriodical extends SelfRegisteringSkriptEvent {
	static {
		Skript.registerEvent("*Periodical", EvtPeriodical.class, EvtPeriodical::new, ScheduledNoWorldEvent.class, "every %timespan%")
				...
				.since("1.0");
		Skript.registerEvent("*Periodical", EvtPeriodical.class, EvtPeriodical::new, ScheduledEvent.class, "every %timespan% in [world[s]] %worlds%")
				.description("An event that is called periodically.")
