...
public final class EvtEntity extends SkriptEvent {
	...
	static {
		Skript.registerEvent("Death", EvtEntity.class, EvtEntity::new, EntityDeathEvent.class, "death [of %-entitydatas%]")
				...
				.since("1.0");
		Skript.registerEvent("Spawn", EvtEntity.class, EvtEntity::new, EntitySpawnEvent.class, "spawn[ing] [of %-entitydatas%]")
