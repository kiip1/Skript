...
public class EvtBlock extends SkriptEvent {
	...
	static {
		...
		Skript.registerEvent("Break / Mine", EvtBlock.class, EvtBlock::new, new Class[]{BlockBreakEvent.class, PlayerBucketFillEvent.class, HangingBreakEvent.class}, "[block] (break[ing]|1¦min(e|ing)) [[of] %-itemtypes/blockdatas%]")
		...
		Skript.registerEvent("Burn", EvtBlock.class, EvtBlock::new, BlockBurnEvent.class, "[block] burn[ing] [[of] %-itemtypes/blockdatas%]")
		...
		Skript.registerEvent("Place", EvtBlock.class, EvtBlock::new, new Class[]{BlockPlaceEvent.class, PlayerBucketEmptyEvent.class, HangingPlaceEvent.class}, "[block] (plac(e|ing)|build[ing]) [[of] %-itemtypes/blockdatas%]")
			...
			.since("1.0, 2.6 (BlockData support)");
		Skript.registerEvent("Fade", EvtBlock.class, EvtBlock::new, BlockFadeEvent.class, "[block] fad(e|ing) [[of] %-itemtypes/blockdatas%]")
			.description("Called when a block 'fades away', e.g. ice or snow melts.")
			.examples("on fade of snow or ice:", "on fade of snow[layers=2]")
			.since("1.0, 2.6 (BlockData support)");
		Skript.registerEvent("Form", EvtBlock.class, EvtBlock::new, BlockFormEvent.class, "[block] form[ing] [[of] %-itemtypes/blockdatas%]")
