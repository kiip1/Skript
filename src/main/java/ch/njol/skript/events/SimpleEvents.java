...
public class SimpleEvents {
	static {
		Skript.registerEvent("Can Build Check", SimpleEvent.class, SimpleEvent::new, BlockCanBuildEvent.class, "[block] can build check")
		...
		Skript.registerEvent("Block Damage", SimpleEvent.class, SimpleEvent::new, BlockDamageEvent.class, "block damag(ing|e)")
				...
				.since("1.0");
		Skript.registerEvent("Flow", SimpleEvent.class, SimpleEvent::new, BlockFromToEvent.class, "[block] flow[ing]", "block mov(e|ing)")
				...
				.since("1.0");
		Skript.registerEvent("Ignition", SimpleEvent.class, SimpleEvent::new, BlockIgniteEvent.class, "[block] ignit(e|ion)")
				...
				.examples("on block ignite:",
						...
						"\t\tcancel event")
				.since("1.0");
		Skript.registerEvent("Physics", SimpleEvent.class, SimpleEvent::new, BlockPhysicsEvent.class, "[block] physics")
				...
				.examples("# prevents sand from falling",
						...
						"	cancel event")
				.since("1.4.6");
		Skript.registerEvent("Piston Extend", SimpleEvent.class, SimpleEvent::new, BlockPistonExtendEvent.class, "piston extend[ing]")
				.description("Called when a piston is about to extend.")
				.examples("on piston extend:",
						"\tbroadcast \"A piston is extending!\"")
				.since("1.0");
		Skript.registerEvent("Piston Retract", SimpleEvent.class, SimpleEvent::new, BlockPistonRetractEvent.class, "piston retract[ing]")
				.description("Called when a piston is about to retract.")
				.examples("on piston retract:",
						"\tbroadcast \"A piston is retracting!\"")
				.since("1.0");
		Skript.registerEvent("Redstone", SimpleEvent.class, SimpleEvent::new, BlockRedstoneEvent.class, "redstone [current] [chang(e|ing)]")
				...
				.since("1.0");
		Skript.registerEvent("Spread", SimpleEvent.class, SimpleEvent::new, BlockSpreadEvent.class, "spread[ing]")
				.description("Called when a new block <a href='#form'>forms</a> as a result of a block that can spread, e.g. water or mushrooms.")
				.examples("on spread:")
				.since("1.0");
		Skript.registerEvent("Chunk Load", SimpleEvent.class, SimpleEvent::new, ChunkLoadEvent.class, "chunk load[ing]")
				.description("Called when a chunk loads. The chunk might or might not contain mobs when it's loaded.")
				.examples("on chunk load:")
				.since("1.0");
		Skript.registerEvent("Chunk Generate", SimpleEvent.class, SimpleEvent::new, ChunkPopulateEvent.class, "chunk (generat|populat)(e|ing)")
				.description("Called after a new chunk was generated.")
				.examples("on chunk generate:")
				.since("1.0");
		Skript.registerEvent("Chunk Unload", SimpleEvent.class, SimpleEvent::new, ChunkUnloadEvent.class, "chunk unload[ing]")
				.description("Called when a chunk is unloaded due to not being near any player.")
				.examples("on chunk unload:")
				.since("1.0");
		Skript.registerEvent("Creeper Power", SimpleEvent.class, SimpleEvent::new, CreeperPowerEvent.class, "creeper power")
				...
				.since("1.0");
		Skript.registerEvent("Zombie Break Door", SimpleEvent.class, SimpleEvent::new, EntityBreakDoorEvent.class, "zombie break[ing] [a] [wood[en]] door")
				...
				.since("1.0");
		Skript.registerEvent("Combust", SimpleEvent.class, SimpleEvent::new, EntityCombustEvent.class, "combust[ing]")
				...
				.examples("on combust:")
				.since("1.0");
		Skript.registerEvent("Explode", SimpleEvent.class, SimpleEvent::new, EntityExplodeEvent.class, "explo(d(e|ing)|sion)")
				.description("Called when an entity (a primed TNT or a creeper) explodes.")
				.examples("on explosion:")
				.since("1.0");
//		Skript.registerEvent(SimpleEvent.class, EntityInteractEvent.class, EntityInteractEvent::new, "interact");// = entity interacts with block, e.g. endermen?; player -> PlayerInteractEvent // likely tripwires, pressure plates, etc.
		Skript.registerEvent("Portal Enter", SimpleEvent.class, SimpleEvent::new, EntityPortalEnterEvent.class, "portal enter[ing]", "entering [a] portal")
				...
				.since("1.0");
		Skript.registerEvent("Heal", SimpleEvent.class, SimpleEvent::new, EntityRegainHealthEvent.class, "heal[ing]")
				...
				.examples("on heal:")
				.since("1.0");
		Skript.registerEvent("Tame", SimpleEvent.class, SimpleEvent::new, EntityTameEvent.class, "[entity] tam(e|ing)")
				.description("Called when a player tames a wolf or ocelot. Can be cancelled to prevent the entity from being tamed.")
				.examples("on tame:")
				.since("1.0");
		Skript.registerEvent("Explosion Prime", SimpleEvent.class, SimpleEvent::new, ExplosionPrimeEvent.class, "explosion prime")
				...
				.since("1.0");
		Skript.registerEvent("Hunger Meter Change", SimpleEvent.class, SimpleEvent::new, FoodLevelChangeEvent.class, "(food|hunger) (level|met(er|re)|bar) chang(e|ing)")
				...
				.since("1.4.4");
		Skript.registerEvent("Fuel Burn", SimpleEvent.class, SimpleEvent::new, FurnaceBurnEvent.class, "fuel burn[ing]")
				...
				.since("1.0");
		Skript.registerEvent("Smelt", SimpleEvent.class, SimpleEvent::new, FurnaceSmeltEvent.class, "[ore] smelt[ing]", "smelt[ing] of ore") //TODO SkriptEvent for "smelt[ing] of %itemtype%"
		.description("Called when a furnace smelts an item in its <a href='expressions.html#ExprFurnaceSlot'>ore slot</a>.")
				.examples("on smelt:")
				.since("1.0");
		Skript.registerEvent("Leaves Decay", SimpleEvent.class, SimpleEvent::new, LeavesDecayEvent.class, "leaves decay[ing]")
				.description("Called when a leaf block decays due to not being connected to a tree.")
				.examples("on leaves decay:")
				.since("1.0");
		Skript.registerEvent("Lightning Strike", SimpleEvent.class, SimpleEvent::new, LightningStrikeEvent.class, "lightning [strike]")
				.description("Called when lightning strikes.")
				.examples("on lightning:", "\tspawn a zombie at location of event-entity")
				.since("1.0");
		Skript.registerEvent("Pig Zap", SimpleEvent.class, SimpleEvent::new, PigZapEvent.class, "pig[ ]zap")
				...
				.examples("on pig zap:")
				.since("1.0");
		Skript.registerEvent("Bed Enter", SimpleEvent.class, SimpleEvent::new, PlayerBedEnterEvent.class, "bed enter[ing]", "[player] enter[ing] [a] bed")
				.description("Called when a player starts sleeping.")
				.examples("on bed enter:")
				.since("1.0");
		Skript.registerEvent("Bed Leave", SimpleEvent.class, SimpleEvent::new, PlayerBedLeaveEvent.class, "bed leav(e|ing)", "[player] leav(e|ing) [a] bed")
				.description("Called when a player leaves a bed.")
				.examples("on player leaving a bed:")
				.since("1.0");
		Skript.registerEvent("Bucket Empty", SimpleEvent.class, SimpleEvent::new, PlayerBucketEmptyEvent.class, "bucket empty[ing]", "[player] empty[ing] [a] bucket")//TODO , "emptying bucket [of %itemtype%]", "emptying %itemtype% bucket") -> place of water/lava)
		.description("Called when a player empties a bucket. You can also use the <a href='#place'>place event</a> with a check for water or lava.")
				...
				.since("1.0");
		Skript.registerEvent("Bucket fill", SimpleEvent.class, SimpleEvent::new, PlayerBucketFillEvent.class, "bucket fill[ing]", "[player] fill[ing] [a] bucket")//TODO , "filling bucket [(with|of) %itemtype%]", "filling %itemtype% bucket");)
		.description("Called when a player fills a bucket.")
				.examples("on player filling a bucket:")
				.since("1.0");
		Skript.registerEvent("Egg Throw", SimpleEvent.class, SimpleEvent::new, PlayerEggThrowEvent.class, "throw[ing] [of] [an] egg", "[player] egg throw")
				.description(
		...
		Skript.registerEvent("Fishing", SimpleEvent.class, SimpleEvent::new, PlayerFishEvent.class, "[player] fish[ing]")
		...
		if (Skript.classExists("org.bukkit.event.player.PlayerItemBreakEvent")) {
			Skript.registerEvent("Item Break", SimpleEvent.class, SimpleEvent::new, PlayerItemBreakEvent.class, "[player] tool break[ing]", "[player] break[ing] (a|the|) tool")
		...
		Skript.registerEvent("Item Damage", SimpleEvent.class, SimpleEvent::new, PlayerItemDamageEvent.class, "item damag(e|ing)")
				...
				.examples("on item damage:",
						"\tcancel event")
				.since("2.5");
		Skript.registerEvent("Tool Change", SimpleEvent.class, SimpleEvent::new, PlayerItemHeldEvent.class, "[player['s]] (tool|item held|held item) chang(e|ing)")
				...
				.since("1.0");
		Skript.registerEvent("Join", SimpleEvent.class, SimpleEvent::new, PlayerJoinEvent.class, "[player] (login|logging in|join[ing])")
				...
				.since("1.0");
		Skript.registerEvent("Connect", SimpleEvent.class, SimpleEvent::new, PlayerLoginEvent.class, "[player] connect[ing]")
				...
				.since("2.0");
		Skript.registerEvent("Kick", SimpleEvent.class, SimpleEvent::new, PlayerKickEvent.class, "[player] (kick|being kicked)")
				...
				.examples("on kick:")
				.since("1.0");
		Skript.registerEvent("Entity Portal", SimpleEvent.class, SimpleEvent::new, EntityPortalEvent.class, "entity portal")
				...
				.since("2.5.3");
		Skript.registerEvent("Portal", SimpleEvent.class, SimpleEvent::new, PlayerPortalEvent.class, "[player] portal")
				...
				.since("1.0");
		Skript.registerEvent("Quit", SimpleEvent.class, SimpleEvent::new, PlayerQuitEvent.class, "(quit[ting]|disconnect[ing]|log[ ]out|logging out|leav(e|ing))")
				.description("Called when a player leaves the server.")
				.examples("on quit:",
						"on disconnect:")
				.since("1.0 (simple disconnection)");
		Skript.registerEvent("Respawn", SimpleEvent.class, SimpleEvent::new, PlayerRespawnEvent.class, "[player] respawn[ing]")
				...
				.examples("on respawn:")
				.since("1.0");
		Skript.registerEvent("Teleport", SimpleEvent.class, SimpleEvent::new, PlayerTeleportEvent.class, "[player] teleport[ing]")
				...
				.since("1.0");
		Skript.registerEvent("Sneak Toggle", SimpleEvent.class, SimpleEvent::new, PlayerToggleSneakEvent.class, "[player] toggl(e|ing) sneak", "[player] sneak toggl(e|ing)")
				...
				.since("1.0");
		Skript.registerEvent("Sprint Toggle", SimpleEvent.class, SimpleEvent::new, PlayerToggleSprintEvent.class, "[player] toggl(e|ing) sprint", "[player] sprint toggl(e|ing)")
				...
				.examples("on sprint toggle:",
						...
						"	send \"Run!\"")
				.since("1.0");
		Skript.registerEvent("Portal Create", SimpleEvent.class, SimpleEvent::new, PortalCreateEvent.class, "portal creat(e|ion)")
		...
		Skript.registerEvent("Projectile Hit", SimpleEvent.class, SimpleEvent::new, ProjectileHitEvent.class, "projectile hit")
		...
		if(Skript.classExists("com.destroystokyo.paper.event.entity.ProjectileCollideEvent"))
			Skript.registerEvent("Projectile Collide", SimpleEvent.class, SimpleEvent::new, ProjectileCollideEvent.class, "projectile collide")
			...
			.since("2.5");
		Skript.registerEvent("Shoot", SimpleEvent.class, SimpleEvent::new, ProjectileLaunchEvent.class, "[projectile] shoot")
				...
				.since("1.0");
		Skript.registerEvent("Sign Change", SimpleEvent.class, SimpleEvent::new, SignChangeEvent.class, "sign (chang[e]|edit)[ing]", "[player] (chang[e]|edit)[ing] [a] sign")
				...
				.since("1.0");
		Skript.registerEvent("Spawn Change", SimpleEvent.class, SimpleEvent::new, SpawnChangeEvent.class, "[world] spawn change")
				.description("Called when the spawn point of a world changes.")
				.examples("on spawn change:",
						"\tbroadcast \"someone changed the spawn!\"")
				.since("1.0");
		Skript.registerEvent("Vehicle Create", SimpleEvent.class, SimpleEvent::new, VehicleCreateEvent.class, "vehicle create", "creat(e|ing|ion of) [a] vehicle")
				.description("Called when a new vehicle is created, e.g. when a player places a boat or minecart.")
				.examples("on vehicle create:")
				.since("1.0");
		Skript.registerEvent("Vehicle Damage", SimpleEvent.class, SimpleEvent::new, VehicleDamageEvent.class, "vehicle damage", "damag(e|ing) [a] vehicle")
				...
				.since("1.0");
		Skript.registerEvent("Vehicle Destroy", SimpleEvent.class, SimpleEvent::new, VehicleDestroyEvent.class, "vehicle destroy", "destr(oy[ing]|uction of) [a] vehicle")
				...
				.examples("on vehicle destroy:",
						"\tcancel event")
				.since("1.0");
		Skript.registerEvent("Vehicle Enter", SimpleEvent.class, SimpleEvent::new, VehicleEnterEvent.class, "vehicle enter", "enter[ing] [a] vehicle")
				...
				.examples("on vehicle enter:",
						...
						"\tcancel event")
				.since("1.0");
		Skript.registerEvent("Vehicle Exit", SimpleEvent.class, SimpleEvent::new, VehicleExitEvent.class, "vehicle exit", "exit[ing] [a] vehicle")
		...
		if (Skript.classExists("org.spigotmc.event.entity.EntityMountEvent")) {
			Skript.registerEvent("Entity Mount", SimpleEvent.class, SimpleEvent::new, EntityMountEvent.class, "mount[ing]")
					.description("Called when entity starts riding another.")
					.examples("on mount:",
							"\tcancel event")
					.since("2.2-dev13b");
			Skript.registerEvent("Entity Dismount", SimpleEvent.class, SimpleEvent::new, EntityDismountEvent.class, "dismount[ing]")
					.description("Called when an entity dismounts.")
					.examples("on dismount:",
							"\tkill event-entity")
					.since("2.2-dev13b");
		}
		Skript.registerEvent("World Init", SimpleEvent.class, SimpleEvent::new, WorldInitEvent.class, "world init[ialization]")
				...
				.since("1.0");
		Skript.registerEvent("World Load", SimpleEvent.class, SimpleEvent::new, WorldLoadEvent.class, "world load[ing]")
				...
				.since("1.0");
		Skript.registerEvent("World Save", SimpleEvent.class, SimpleEvent::new, WorldSaveEvent.class, "world sav(e|ing)")
				...
				.since("1.0");
		Skript.registerEvent("World Unload", SimpleEvent.class, SimpleEvent::new, WorldUnloadEvent.class, "world unload[ing]")
		...
		if (Skript.classExists("org.bukkit.event.entity.EntityToggleGlideEvent")) {
			Skript.registerEvent("Gliding State Change", SimpleEvent.class, SimpleEvent::new, EntityToggleGlideEvent.class, "(gliding state change|toggl(e|ing) gliding)")
					...
					.since("2.2-dev21");
			Skript.registerEvent("AoE Cloud Effect", SimpleEvent.class, SimpleEvent::new, AreaEffectCloudApplyEvent.class, "(area|AoE) [cloud] effect")
		...
		Skript.registerEvent("Sheep Regrow Wool", SimpleEvent.class, SimpleEvent::new, SheepRegrowWoolEvent.class, "sheep [re]grow[ing] wool")
				.description("Called when sheep regrows its sheared wool back.")
				.examples("on sheep grow wool:",
						"\tcancel event")
				.since("2.2-dev21");
		Skript.registerEvent("Inventory Open", SimpleEvent.class, SimpleEvent::new, InventoryOpenEvent.class, "inventory open[ed]")
				.description("Called when an inventory is opened for player.")
				.examples("on inventory open:",
						"\tclose player's inventory")
				.since("2.2-dev21");
		Skript.registerEvent("Inventory Close", SimpleEvent.class, SimpleEvent::new, InventoryCloseEvent.class, "inventory clos(ing|e[d])")
				...
				.since("2.2-dev21");
		Skript.registerEvent("Slime Split", SimpleEvent.class, SimpleEvent::new, SlimeSplitEvent.class, "slime split[ting]")
		...
		if (Skript.classExists("org.bukkit.event.entity.EntityResurrectEvent")) {
			Skript.registerEvent("Resurrect Attempt", SimpleEvent.class, SimpleEvent::new, EntityResurrectEvent.class, "[entity] resurrect[ion] [attempt]")
		...
		Skript.registerEvent("Player World Change", SimpleEvent.class, SimpleEvent::new, PlayerChangedWorldEvent.class, "[player] world chang(ing|e[d])")
				...
				.since("2.2-dev28");
		Skript.registerEvent("Flight Toggle", SimpleEvent.class, SimpleEvent::new, PlayerToggleFlightEvent.class, "[player] flight toggl(e|ing)", "[player] toggl(e|ing) flight")
		...
		if (Skript.classExists("org.bukkit.event.player.PlayerLocaleChangeEvent")) {
			Skript.registerEvent("Language Change", SimpleEvent.class, SimpleEvent::new, PlayerLocaleChangeEvent.class, "[player] (language|locale) chang(e|ing)", "[player] chang(e|ing) (language|locale)")
		...
		if (Skript.classExists("com.destroystokyo.paper.event.player.PlayerJumpEvent")) {
			Skript.registerEvent("Jump", SimpleEvent.class, SimpleEvent::new, PlayerJumpEvent.class, "[player] jump[ing]")
		...
		if (Skript.classExists("org.bukkit.event.player.PlayerSwapHandItemsEvent")) {
			Skript.registerEvent("Hand Item Swap", SimpleEvent.class, SimpleEvent::new, PlayerSwapHandItemsEvent.class, "swap[ping of] [(hand|held)] item[s]")
		...
		Skript.registerEvent("Server List Ping", SimpleEvent.class, SimpleEvent::new, (Skript.classExists("com.destroystokyo.paper.event.server.PaperServerListPingEvent") ? PaperServerListPingEvent.class : ServerListPingEvent.class), "server [list] ping")
		...
		if (Skript.classExists("org.bukkit.event.entity.EntityToggleSwimEvent")) {
			Skript.registerEvent("Swim Toggle", SimpleEvent.class, SimpleEvent::new, EntityToggleSwimEvent.class, "[entity] toggl(e|ing) swim",
		...
		if (Skript.classExists("org.bukkit.event.player.PlayerRiptideEvent")) {
			Skript.registerEvent("Riptide", SimpleEvent.class, SimpleEvent::new, PlayerRiptideEvent.class, "[use of] riptide [enchant[ment]]")
		...
		if (Skript.classExists("com.destroystokyo.paper.event.player.PlayerArmorChangeEvent")) {
			Skript.registerEvent("Armor Change", SimpleEvent.class, SimpleEvent::new, PlayerArmorChangeEvent.class, "[player] armor change[d]")
		...
		if (Skript.classExists("org.bukkit.event.block.SpongeAbsorbEvent")) {
			Skript.registerEvent("Sponge Absorb", SimpleEvent.class, SimpleEvent::new, SpongeAbsorbEvent.class, "sponge absorb")
		...
		Skript.registerEvent("Enchant Prepare", SimpleEvent.class, SimpleEvent::new, PrepareItemEnchantEvent.class, "[item] enchant prepare")
			...
			.since("2.5");
		Skript.registerEvent("Enchant", SimpleEvent.class, SimpleEvent::new, EnchantItemEvent.class, "[item] enchant")
		...
		.since("2.5");
		Skript.registerEvent("Inventory Pickup", SimpleEvent.class, SimpleEvent::new, InventoryPickupItemEvent.class, "inventory pick[ ]up")
				.description("Called when an inventory (a hopper, a hopper minecart, etc.) picks up an item")
				.examples("on inventory pickup:")
				.since("2.5.1");
		Skript.registerEvent("Horse Jump", SimpleEvent.class, SimpleEvent::new, HorseJumpEvent.class, "horse jump")
		...
		if(Skript.classExists("org.bukkit.event.block.BlockFertilizeEvent"))
			Skript.registerEvent("Block Fertilize", SimpleEvent.class, SimpleEvent::new, BlockFertilizeEvent.class, "[block] fertilize")
			...
			.since("2.5");
		Skript.registerEvent("Arm Swing", SimpleEvent.class, SimpleEvent::new, PlayerAnimationEvent.class, "[player] arm swing")
		...
		if (Skript.classExists("org.bukkit.event.player.PlayerItemMendEvent")) {
			Skript.registerEvent("Item Mend", SimpleEvent.class, SimpleEvent::new, PlayerItemMendEvent.class, "item mend[ing]")
		...
		Skript.registerEvent("Anvil Prepare", SimpleEvent.class, SimpleEvent::new, PrepareAnvilEvent.class, "anvil prepar(e|ing)")
		...
		if (Skript.classExists("io.papermc.paper.event.player.PlayerTradeEvent")) {
			Skript.registerEvent("Player Trade", SimpleEvent.class, SimpleEvent::new, PlayerTradeEvent.class, "player trad(e|ing)")
		...
		if (Skript.classExists("com.destroystokyo.paper.event.entity.EntityJumpEvent")) {
			Skript.registerEvent("Entity Jump", SimpleEvent.class, SimpleEvent::new, EntityJumpEvent.class, "entity jump[ing]")
		...
		if (Skript.classExists("com.destroystokyo.paper.event.block.AnvilDamagedEvent")) {
			Skript.registerEvent("Anvil Damage", SimpleEvent.class, SimpleEvent::new, AnvilDamagedEvent.class, "anvil damag(e|ing)")
