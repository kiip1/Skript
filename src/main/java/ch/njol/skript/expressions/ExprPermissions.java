...
public class ExprPermissions extends SimpleExpression<String> {
	...
	static {
		Skript.registerExpression(ExprPermissions.class, ExprPermissions::new, String.class, ExpressionType.PROPERTY, "[(all [[of] the]|the)] permissions (from|of) %players%", "[(all [[of] the]|the)] %players%'[s] permissions");
	}
