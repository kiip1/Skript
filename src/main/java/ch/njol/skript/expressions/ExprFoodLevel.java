...
public class ExprFoodLevel extends PropertyExpression<Player, Number> {
	...
	static {
		Skript.registerExpression(ExprFoodLevel.class, ExprFoodLevel::new, Number.class, ExpressionType.PROPERTY, "[the] (food|hunger)[[ ](level|met(er|re)|bar)] [of %players%]", "%players%'[s] (food|hunger)[[ ](level|met(er|re)|bar)]");
	}
