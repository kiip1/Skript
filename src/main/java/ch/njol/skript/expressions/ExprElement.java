...
public class ExprElement extends SimpleExpression<Object> {
	...
	static {
		Skript.registerExpression(ExprElement.class, ExprElement::new, Object.class, ExpressionType.PROPERTY, "(0:[the] first|1:[the] last|2:[a] random|3:[the] %-number%(st|nd|rd|th)|4:[the] %-number%(st|nd|rd|th) [to] last) element [out] of %objects%");
	}
