...
public class ExprLastLoadedServerIcon extends SimpleExpression<CachedServerIcon> {
	...
	static {
		Skript.registerExpression(ExprLastLoadedServerIcon.class, ExprLastLoadedServerIcon::new, CachedServerIcon.class, ExpressionType.SIMPLE, "[the] [last[ly]] loaded server icon");
	}
