...
public class ExprBlock extends WrapperExpression<Block> {
	static {
		Skript.registerExpression(ExprBlock.class, ExprBlock::new, Block.class, ExpressionType.SIMPLE, "[the] [event-]block");
		Skript.registerExpression(ExprBlock.class, ExprBlock::new, Block.class, ExpressionType.COMBINED, "[the] block %direction% [%location%]");
	}
