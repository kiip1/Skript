...
public class ExprProtocolVersion extends SimpleExpression<Long> {
	...
	static {
		Skript.registerExpression(ExprProtocolVersion.class, ExprProtocolVersion::new, Long.class, ExpressionType.SIMPLE, "[the] [server] [(sent|required|fake)] protocol version [number]");
	}
